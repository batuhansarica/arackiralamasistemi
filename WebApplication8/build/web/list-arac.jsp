			...
			<table class="table">
				...
				<tbody>
					...
					<c:forEach var="arac" items="${listArac}">
						...
						<tr>
							<td style="color: white"><c:out value="${arac.id}" /></td>
							<td style="color: white"><c:out value="${arac.plaka}" /></td>
							<td style="color: white"><c:out value="${arac.marka}" /></td>
							<td style="color: white"><c:out value="${arac.model}" /></td>
							<td style="color: white"><c:out value="${arac.renk}" /></td>
                                                        <c:if test="${loggedUser.email == 'admin' && loggedUser.password == 'admin'}"> 
							<td> <a style="color:red" href="<%=request.getContextPath()%>/AracServlet/delete?id=<c:out value='${arac.id}' />">Sil</a>
                                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                                            <a href="<%=request.getContextPath()%>/AracServlet/edit?id=<c:out value='${arac.id}' />">Düzenle</a>
				...
				<a href="<%=request.getContextPath()%>/AracServlet/new" class="btn btn-danger">Araç Ekle</a>
			</div>
                                </c:if>
