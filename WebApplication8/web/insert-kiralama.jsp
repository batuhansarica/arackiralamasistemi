        ...
        <div class="card card-signin my-5">
            <div class="card-body">
				<c:if test="${kiralama != null}">
					<form action="KiralamaServlet/update" method="post">
				</c:if>
				<c:if test="${kiralama == null}">
					<form action="KiralamaServlet/insert" method="post">
				</c:if>
				...
				<c:if test="${kiralama != null}">
					<input type="hidden" name="id" value="<c:out value='${kiralama.id}' />" />
                                        ...
                                        <fieldset class="form-group">
                                            <label><strong>Araç</strong></label>
                                            <br>
				<select name="arac" id="arac" class="form-control"> 
                                    <c:forEach var="arac" items="${listArac}">
                                        <option value="${arac.id}">${arac.plaka}-${arac.marka}-${arac.model}-${arac.renk}</option>
                                    </c:forEach>
					</select>
				...
				<div class="form-label-group">
                                        ...
                                        <input type="date" id="baslangicTarihi" value="<c:out value='${kiralama.kiralamaBaslangic}' />" class="form-control" name="baslangicTarihi" required="required">
                                        <label>Başlama Tarihi</label>
                                </div>
				
				<div class="form-label-group">
                                        <input type="date" id="bitisTarihi" value="<c:out value='${kiralama.kiralamaBitis}' />" class="form-control" name="bitisTarihi" required="required">
